...
export const Desktop: React.FC<IDesktop> = ({ isMain, title, about, img, list, formButton, learnMoreButton }) => {
  ...
  const renderedList = list.map(({ itemTitle, itemSubtitle }, idx) => (
    <div key={ itemTitle + idx } style={ { width: '33.33%' } }>
      <h6 className={ classes.h6 } dangerouslySetInnerHTML={ { __html: itemTitle } }/>
      <p className={ classes.smallSubtitle } dangerouslySetInnerHTML={ { __html: itemSubtitle } }/>
    </div>
  ));
      ...
      <div className={ classes.textWrapper }>
        <div className={ classes.textInnerWrapper }>
          ...
          <div style={ { marginTop: 'auto', paddingTop: '24px' } }>
            ...
            <Button className={ isMain ? classes.learnMoreButtonMain : classes.learnMoreButtonSecond } variant='text'>
