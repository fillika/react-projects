    ...
    <div className={ classes.wrapper }>
      <div className={ classes.textWrapper }>
        ...
        <p className={ classes.subtitle }>
          По&nbsp;версии Global&nbsp;Finance&nbsp;— Best&nbsp;Digital&nbsp;Bank&nbsp;Award&nbsp;2018 </p>

        <div className={ classes.imageWrapper }>
          <picture>
            <img
              loading='lazy' src='https://acdn.tinkoff.ru/static/pages/files/6c2953f3-252f-4035-9358-4980d37f1be2.svg'
              alt='QR code'/>
          </picture>
        </div>
      </div>
      ...
      <div className={ classes.buttonWrapper }>
        <Button
          ...
          <AppleIcon
            style={ { width: '32px' } } fontSize='small'/>
          Подробнее в App Store
        </Button>

        <Button
          className={ commonClasses.textButton } disableRipple
...
const GooglePlayIcon: React.FC = () => (
  <svg
    width='32' xmlns='http://www.w3.org/2000/svg' focusable='false' viewBox='0 0 48 48'>
    <path
